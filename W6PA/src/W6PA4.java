...
Pair pair = new Pair();
W6PA4  w1 = new W6PA4(pair);
W6PA4 w2 = new W6PA4(pair);
W6PA4 w3 = new W6PA4(pair);
w1.start();
w2.start();
w3.start();
...
Execution of two or more threads occurs in a random order. The keyword 'synchronized' in Java is used to control 
the execution of thread in a strict sequence.
